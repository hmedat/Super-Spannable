 ...
 * https://github.com/imbryk/CustomViews/blob/master/src/com/imbryk/text/BulletSpanWithRadius.java
 */
public class CustomBulletSpan implements LeadingMarginSpan {
    ...
    public CustomBulletSpan(int bulletRadius, int gapWidth) {
        mGapWidth = gapWidth;
    ...
    public CustomBulletSpan(int bulletRadius, int gapWidth, int color) {
        mGapWidth = gapWidth;
        mBulletRadius = bulletRadius;
        mWantColor = true;
        mColor = color;
